...
describe('Variant Select', () => {
  ...
  describe('Lamppanel Click', () => {
    it('Tests the Lamppanel Highlight', () => {
        ...
        cy.get(keys).contains("Q").click().then(() => {
            cy.get(lamps).contains("S").should('have.class', 'highlight-red')
          });
            cy.wait(200)
    })
  })
  ...
  describe('Cookies', () => {
    it('Cookies', () => {
      ...
      cy.visit(url)
      cy.setCookie('variant', 'B (A-133 modified)')
  ...
  describe('Retain State', () => {
    it('Tests if State is loaded with Cookies', () => {
      ...
      cy.setCookie('variant', 'B (A-133 modified)')
      cy.setCookie('rotors', "[\"I\",\"III\",\"II\"]")
      cy.setCookie('plugboard', "{'F': 'T','T': 'F', 'N' : 'B', 'B': 'N'}")
      cy.setCookie('positions', "[\"B\",\"R\", \"N\"]")
      cy.setCookie('reflector', 'UKW-A')
      cy.setCookie('input_history', 'HALLO')
      cy.setCookie('history', 'YPNMP')
      cy.wait(200)
